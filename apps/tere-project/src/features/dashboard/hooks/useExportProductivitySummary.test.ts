...
test('fully live range: export payload and Sheet values match canonical API response', async () => {
  ...
  assert.deepEqual(sheet.values, [
    ...
    ['2026-06', 'live', 'WP', 2, 62.5, 40, 3, '', 'Live Jira', 'Complete', ''],
    [],
    ['Details'],
    ['Group', 'Boards', 'Name', 'Month', 'Source', 'Rule', 'Metric Basis', 'SP Total', 'WP Total', 'Working Days', 'Source Label', 'Coverage', 'Warning'],
    ['Loan', 'Loan Web', 'Alpha', '2026-06', 'live', 'v3', 'WP', 10, 20, 20, 'Live Jira', 'Complete', ''],
    ['User', 'User Mobile, User Web', 'Beta', '2026-06', 'live', 'v3', 'WP', 15, 20, 20, 'Live Jira', 'Complete', ''],
    [],
    ['Coverage Failures'],
...
test('archived/mixed range: SP-only metric basis, partial month never complete or zero', async () => {
  ...
  assert.deepEqual(sheet.values, [
    ...
    [],
    ['Month', 'Source', 'Metric Basis', 'Active Members', 'Productivity %', 'SP Total', 'Bugs Raised', 'Bugs Done', 'Source Label', 'Coverage', 'Warning'],
    ['2025-12', 'archive', 'SP', 1, 11.842105, 18, 1, '', 'Archived', 'Complete', ''],
    ['2026-01', 'partial', 'SP', 1, '', '', '', '', 'Partial', 'Partial', 'Report coverage is incomplete'],
    [],
    ['Details'],
    ['Group', 'Boards', 'Name', 'Month', 'Source', 'Rule', 'Metric Basis', 'SP Total', 'WP Total', 'Working Days', 'Source Label', 'Coverage', 'Warning'],
    ['User', 'Ambis Mobile, Ambis Web', 'Legacy Member', '2025-12', 'archive', 'v3', 'SP', 18, '', 19, 'Archived', 'Complete', ''],
    ['User', 'Ambis Mobile, Ambis Web', 'Legacy Member', '2026-01', 'partial', 'v3', 'SP', '', '', 21, 'Partial', 'Partial', 'Report coverage is incomplete'],
    [],
    ['Coverage Failures'],
    ['Month', 'Scope', 'Group', 'Board', 'Reason'],
